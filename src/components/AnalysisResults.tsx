...
export const AnalysisResults: React.FC<AnalysisResultsProps> = ({ results }) => {
  ...
  const downloadResults = () => {
    try {
      ...
      const performanceSheet = XLSX.utils.json_to_sheet(results.performance);
      ...
      // PO Analysis Sheet
      const poSheet = XLSX.utils.json_to_sheet(results.poAnalysis);
      XLSX.utils.book_append_sheet(wb, poSheet, 'PO Analysis');
      
      // Student-wise Analysis Sheet
      const studentSheet = XLSX.utils.json_to_sheet(results.studentWiseAnalysis);
